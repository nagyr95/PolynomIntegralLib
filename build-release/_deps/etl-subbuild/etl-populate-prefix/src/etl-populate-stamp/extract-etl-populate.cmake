...
#
get_filename_component(filename "F:/Ricsi/prog/cpp/polynomIntLib/build-release/_deps/etl-subbuild/etl-populate-prefix/src/20.40.0.zip" ABSOLUTE)
get_filename_component(directory "F:/Ricsi/prog/cpp/polynomIntLib/build-release/_deps/etl-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-etl-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-etl-populate${i}")
